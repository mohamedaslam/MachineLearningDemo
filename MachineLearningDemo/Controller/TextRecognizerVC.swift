...
import CoreML
import Vision
class TextRecognizerVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func showDetectedText() {
       ...
       // detectedText.text = result
        detectedText.text = "The image contain text."
    }
