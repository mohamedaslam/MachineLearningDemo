//
//  FoodRecognizerVC.swift
//  MachineLearningDemo
//
//  Created by Mohammed Aslam on 02/02/18.
...
class FoodRecognizerVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
